...
def responder(pregunta: str, spreadsheet_id: str, historial: str = "") -> str:
    ...
    try:
        con, schema, catalogo = get_data(spreadsheet_id)
    except RuntimeError as e:
        if "SIN_CATALOGO" in str(e):
            return (
                "Este cliente todavia no tiene documentado el catalogo de datos "
                "(pestania '_catalogo'). Contacta a FACHAVI para completarlo."
            )
