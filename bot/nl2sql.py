...
_SISTEMA_SQL = (
    ...
    "- Si el usuario menciona VARIOS valores de una misma dimensión (por ejemplo, "
    "'Vivienda y Deudas'), usa OR/IN para incluirlos a todos; no los combines "
    "con AND ni descartes uno.\n"
